...
public class DrawableUtils
{
	public static int calculateInSampleSize(BitmapFactory.Options options, int reqWidth, int reqHeight)
	{
	    ...
	    if ((height > reqHeight && reqHeight != -1) || (width > reqWidth && reqWidth != -1)) {
	        ...
	        while (((halfHeight / inSampleSize) > reqHeight || reqHeight == -1)
	                && ((halfWidth / inSampleSize) > reqWidth || reqWidth == -1)) {
	            inSampleSize *= 2;
	        }
	    }
